...
namespace Snowflake
{
    namespace Client
    {
        ...
        ResultSetJson::ResultSetJson() : ResultSet(SF_JSON_FORMAT)
        {
            ; // Do nothing
        }
        ...
        ResultSetJson::ResultSetJson(
            ...
            const std::string &tzString) : ResultSet(metadata, tzString, SF_JSON_FORMAT)
        {
            m_chunk = nullptr;
            appendChunk(rowset);
        }
        ...
        SF_STATUS STDCALL ResultSetJson::getCellAsBool(size_t idx, sf_bool *out_data)
        {
            ...
            *out_data = SF_BOOLEAN_FALSE;
            ...
            {
                *out_data = strcmp("1", cell->valuestring) == 0 ? SF_BOOLEAN_TRUE : SF_BOOLEAN_FALSE;
                return SF_STATUS_SUCCESS;
            }
        ...
        SF_STATUS STDCALL ResultSetJson::getCellAsInt32(size_t idx, int32 *out_data)
        {
            ...
            *out_data = 0;
            ...
            if ((value == 0 && std::strcmp(cell->valuestring, "0") != 0) || endptr == cell->valuestring)
            {
            ...
            if (((value == LONG_MIN || value == LONG_MAX) && errno == ERANGE) || (value < SF_INT32_MIN || value > SF_INT32_MAX))
            {
        ...
        SF_STATUS STDCALL ResultSetJson::getCellAsUint32(size_t idx, uint32 *out_data)
        {
            ...
            *out_data = 0;
            ...
            if (((value == 0 || value == ULONG_MAX) && errno == ERANGE) || (isNeg && value < (SF_UINT64_MAX - SF_UINT32_MAX)) || (!isNeg && value > SF_UINT32_MAX))
            {
        ...
        SF_STATUS STDCALL ResultSetJson::getCellAsTimestamp(size_t idx, SF_TIMESTAMP *out_data)
        {
            ...
            if (snowType == SF_DB_TYPE_DATE || snowType == SF_DB_TYPE_TIME || snowType == SF_DB_TYPE_TIMESTAMP_LTZ || snowType == SF_DB_TYPE_TIMESTAMP_NTZ || snowType == SF_DB_TYPE_TIMESTAMP_TZ)
            {
