/*
 * File:   SecureStorageUnSup.hpp *
 * Copyright (c) 2013-2020 Snowflake Computing
 */
#ifndef PROJECT_SECURESTORAGE_UNSUP_H
#define PROJECT_SECURESTORAGE_UNSUP_H
...
namespace sf
{
    ...
    public:
         ...
         * updateCredential
         *
         * API to update an existing token.
         *
         * @param host - snowflake host url associated
         * with the credential
         ...
         * @param cred - credential to be stored
         * @return ERROR / SUCCESS
         */
...
#endif //PROJECT_SECURESTORAGE_UNSUP_H
