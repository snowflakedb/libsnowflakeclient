...
#define OCSP_TELEMETRY_OCSP_REQUEST_MAX_LEN 4096
...
#define OSCP_RESPONSE_CERT_STATUS_INVALID "OCSPResponseCertStatusInvalid"
...
#define OCSP_REQUEST_ALLOCATION_FAILURE "OCSPRequestAllocationFailure"
...
typedef struct ocsp_telemetry_data
{
  ...
  char ocsp_req_b64[OCSP_TELEMETRY_OCSP_REQUEST_MAX_LEN];
...
void sf_otd_set_event_sub_type(char *ocsp_responder_url, SF_OTD* ocsp_telemetry_data);
