...
set(stdout_log "C:/workspaces/libsnowflakeclient/deps/arrow-22.0.0/cpp/cmake-build-win64-VS17-Debug/src/xsimd_ep-stamp/xsimd_ep-install-out.log")
set(stderr_log "C:/workspaces/libsnowflakeclient/deps/arrow-22.0.0/cpp/cmake-build-win64-VS17-Debug/src/xsimd_ep-stamp/xsimd_ep-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  C:/workspaces/libsnowflakeclient/deps/arrow-22.0.0/cpp/cmake-build-win64-VS17-Debug/src/xsimd_ep-stamp/xsimd_ep-install-*.log")
  endif()
  ...
  if(NOT "Visual Studio 17 2022" MATCHES "Ninja")
    set(msg "xsimd_ep install command succeeded.  See also C:/workspaces/libsnowflakeclient/deps/arrow-22.0.0/cpp/cmake-build-win64-VS17-Debug/src/xsimd_ep-stamp/xsimd_ep-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
