...
SNOWFLAKE_TEST_USER="${1:-$SNOWFLAKE_TEST_USER}"
SNOWFLAKE_TEST_PASSWORD="${2:-$SNOWFLAKE_TEST_PASSWORD}"
SNOWFLAKE_TEST_ACCOUNT="${3:-$SNOWFLAKE_TEST_ACCOUNT}"
SNOWFLAKE_TEST_WAREHOUSE="${4:-$SNOWFLAKE_TEST_WAREHOUSE}"
SNOWFLAKE_TEST_DATABASE="${5:-$SNOWFLAKE_TEST_DATABASE}"
SNOWFLAKE_TEST_SCHEMA="${6:-$SNOWFLAKE_TEST_SCHEMA}"
SNOWFLAKE_TEST_ROLE="${7:-$SNOWFLAKE_TEST_ROLE}"
