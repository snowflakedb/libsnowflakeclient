...
# Build dependencies, libsnowflakeclient and run tests
export GCC=gcc-5 GXX=g++-5
echo "==> building dependencies"
./scripts/build_dependencies.sh -t Debug
mv deps-build/linux/aws/lib deps-build/linux/aws/lib64
echo "==> building libsnowflakeclient"
./scripts/build_libsnowflakeclient.sh -t Debug
echo "==> build complete"
