...
working_dir=$PWD/libsnowflakeclient/$CMAKE_DIR/CMakeFiles/snowflakeclient.dir/
...
lcov -c -d $PWD/libsnowflakeclient/$CMAKE_DIR/CMakeFiles/snowflakeclient.dir/ --output-file coverage_unfiltered.info
