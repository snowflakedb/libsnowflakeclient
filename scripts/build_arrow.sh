...
ARROW_CXXFLAGS="-std=c++17 -O2 -fPIC -pthread -Wno-documentation"
...
echo === zip_files "arrow" "$ARROW_VERSION" "$target" "arrow arrow_deps"
zip_files "arrow" "$ARROW_VERSION" "$target" "arrow arrow_deps"
