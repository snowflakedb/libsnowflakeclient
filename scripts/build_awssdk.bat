...
-DCMAKE_C_FLAGS="/D CURL_STATICLIB /Z7 /W2 /ZH:SHA_256 /guard:cf /Qspectre /sdl" ^
-DCMAKE_CXX_FLAGS="/D WIN32 /D _WINDOWS /D CURL_STATICLIB /EHsc /GR /Z7 /W2 /ZH:SHA_256 /guard:cf /Qspectre /sdl" ^
