...
- On Windows: Visual Studio 2022 with following idivisual components installed

  - MSVC v143 - VS 2022 C++ x64/x86 build tools
  - MSVC v143 - VS 2022 C++ x64/x86 Spectre-mitigrated libs
  - MSVC v142 - VS 2019 C++ x64/x86 build tools (if you need compatibility with application built with VS 2019)
  - MSVC v142 - VS 2019 C++ x64/x86 Spectre-mitigrated libs (if you need compatibility with application built with VS 2019)
...
Windows
^^^^^^^^^^
Set environment variables: PLATFORM: [x64, x86], BUILD_TYPE: [Debug, Release], VS_VERSION: [VS16, VS17] and run the script.
