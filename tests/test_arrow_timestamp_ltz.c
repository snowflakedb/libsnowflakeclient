...
void test_arrow_timestamp_ltz_helper(sf_bool use_zero_precision) {
    ...
    TEST_CASE_TO_STRING p0_test_cases[] = {
        ...
        { .c1 =  9, .c2 = f1_neg_zero_time, .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 10, .c2 = f1_neg_reg_date,  .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 11, .c2 = f1_neg_reg_time,  .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
    ...
    TEST_CASE_TO_STRING p9_test_cases[] = {
        ...
        { .c1 =  8, .c2 = f2_neg_zero_time, .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 =  9, .c2 = f2_neg_reg_date,  .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 10, .c2 = f2_neg_reg_time,  .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        ...
        { .c1 = 13, .c2 = f2_oob_nano,      .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
