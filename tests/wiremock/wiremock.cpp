...
namespace Snowflake
{
    namespace Client
    {
        int WiremockRunner::S_WIREMOCK_TIMEOUT = 10000;
        ...
        void WiremockRunner::addMapping(const std::string& mapping)
        {
            ...
            const std::string request = std::string("curl -s") + " -H 'Accept: application/json'" + " -H 'Content-Type: application-json'" + " -d '" + body + "'" + " -X POST http://" + wiremockHost + ":" + wiremockAdminPort + "/__admin/mappings";
            int ret = std::system(request.c_str());
        ...
        {
            waitForWiremockRunning();
            std::string request = std::string("curl -s") + " -X POST http://" + wiremockHost + ":" + wiremockAdminPort + "/__admin/reset";
            int ret = std::system(request.c_str());
        ...
        void WiremockRunner::terminateWiremock()
        {
            ...
            std::string request = std::string("curl -s") + " -X POST http://" + wiremockHost + ":" + wiremockAdminPort + "/__admin/shutdown";
        ...
        void WiremockRunner::setup()
        {
            ...
            try
            {
                ...
                const std::string command = "java -jar " + getHomePath() + wiremockPath
                    ...
                    + " --https-keystore ../wiremock/https.jks"
