...
void execute_insert_query_with_two_different_bindings(SF_STMT* stmt, char* timezone){
    ...
    TZ_input.value = expected_tz_results;
    TZ_input.len = 38;

    LTZ_input.idx = 4;
    LTZ_input.c_type = SF_C_TYPE_STRING;
    LTZ_input.value = expected_tz_results;
    LTZ_input.len = 38;
...
void test_verify_data_types_with_two_different_binding_UTC(void** unused) {
    ...
    char expected_ltz_results[5][38] = { "1-01-01 23:24:25.987000000", "9999-12-30 23:24:25.987000000","2025-04-08 11:37:25.326000000","2024-06-22 23:37:25.520000000", "2000-01-01 00:00:00.000000000" };
#else
