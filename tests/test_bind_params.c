...
void execute_insert_query_with_two_different_bindings(SF_STMT* stmt, char* timezone) {
    ...
    char timestamp_tz_array[5][38] = { "0001-01-01 23:24:25.987000000 -00:00", "9999-12-30 23:24:25.987000000 +02:00","2025-04-08 11:37:25.326000000 +09:00","2024-06-22 23:37:25.520000000 -09:00", "2000-01-01 00:00:00.000000000 -08:00" };
    ...
    TZ_input.value = timestamp_tz_array;
    TZ_input.len = 38;

    LTZ_input.idx = 4;
    LTZ_input.c_type = SF_C_TYPE_STRING;
    LTZ_input.value = timestamp_tz_array;
    LTZ_input.len = 38;
...
void test_verify_data_types_with_two_different_binding_UTC(void** unused) {
    ...
    char expected_tz_results[5][38] = { "1-01-01 23:24:25.987000000 -00:00", "9999-12-30 23:24:25.987000000 +02:00","2025-04-08 11:37:25.326000000 +09:00","2024-06-22 23:37:25.520000000 -09:00", "2000-01-01 00:00:00.000000000 -08:00" };
    char expected_ltz_results[5][38] = { "1-01-01 23:24:25.987000000", "9999-12-30 21:24:25.987000000","2025-04-08 02:37:25.326000000","2024-06-23 08:37:25.520000000", "2000-01-01 08:00:00.000000000" };
#else
    ...
    char expected_tz_results[5][38] = { "0001-01-01 23:24:25.987000000 -00:00", "9999-12-30 23:24:25.987000000 +02:00","2025-04-08 11:37:25.326000000 +09:00","2024-06-22 23:37:25.520000000 -09:00", "2000-01-01 00:00:00.000000000 -08:00" };
    char expected_ltz_results[5][31] = { "0001-01-01 23:24:25.987000000", "9999-12-30 21:24:25.987000000","2025-04-08 02:37:25.326000000","2024-06-23 08:37:25.520000000", "2000-01-01 08:00:00.000000000" };
#endif
    SF_STATUS status;
    SF_CONNECT* sf = setup_snowflake_connection();
    // turn on FAIL_OPEN to around certificate issue with GCP
