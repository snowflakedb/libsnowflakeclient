...
void test_arrow_timestamp_tz_helper(sf_bool use_zero_precision) {
    // Test cases.
    // Note: Output expects the time zone to be set to America/New_York.
    const char * empty            = "";
    ...
    const char * f1_max_out         = "9999-12-31 23:59:59 -05:00";
    ...
    const char * f2_trash           = "ABCD-EF-GH IJ:KL:MN.OPQRSTUVW +00:00";
    const char * f2_neg_zero_time   = "1970-01-01 -00:00:00.000000000 +00:00";
    const char * f2_neg_reg_date    = "-1970-01-01 12:34:56.987654321 +00:00";
    const char * f2_neg_reg_time    = "1970-01-01 -12:34:56.987654321 +00:00";
    ...
    TEST_CASE_TO_STRING p0_test_cases[] = {
        ...
        { .c1 =  9, .c2 = f1_neg_zero_time, .c2_len = 27, .c2_out = "",                 .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 10, .c2 = f1_neg_reg_date,  .c2_len = 27, .c2_out = "",                 .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 11, .c2 = f1_neg_reg_time,  .c2_len = 27, .c2_out = "",                 .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
    ...
    TEST_CASE_TO_STRING p9_test_cases[] = {
        ...
        { .c1 =  8, .c2 = f2_neg_zero_time, .c2_len = 37, .c2_out = "",                 .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 =  9, .c2 = f2_neg_reg_date,  .c2_len = 37, .c2_out = "",                 .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 10, .c2 = f2_neg_reg_time,  .c2_len = 37, .c2_out = "",                 .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        ...
        { .c1 = 13, .c2 = f2_oob_nano,      .c2_len = 37, .c2_out = "",                 .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
    ...
    status = snowflake_query(
        sfstmt,
        "alter session set timestamp_tz_output_format = 'YYYY-MM-DD HH24:MI:SS.FF9 TZH:TZM'",
        0);
    if (status != SF_STATUS_SUCCESS) {
        dump_error(&(sfstmt->error));
    }
