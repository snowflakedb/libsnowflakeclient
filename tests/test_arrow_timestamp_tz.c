...
void test_arrow_timestamp_tz_helper(sf_bool use_zero_precision) {
    ...
    TEST_CASE_TO_STRING p9_test_cases[] = {
        ...
        { .c1 = 35, .c2 = &f2_epoch_eve,     .c2_len = 29, .c2_out = "1969-12-31 23:59:59.999999999", .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 36, .c2 = &f2_epoch,         .c2_len = 29, .c2_out = "1970-01-01 00:00:00.000000000", .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 37, .c2 = &f2_epochalypse,   .c2_len = 29, .c2_out = "2038-01-19 03:14:08.000000000", .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 38, .c2 = &f2_min,           .c2_len = 29, .c2_out = "0001-01-01 00:00:00.000000000", .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 39, .c2 = &f2_max,           .c2_len = 29, .c2_out = "9999-12-31 23:59:59.999999999", .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 40, .c2 = &f2_noon,          .c2_len = 29, .c2_out = "1970-01-01 12:00:00.000000000", .c2_is_null = SF_BOOLEAN_FALSE }
    };
