...
void test_arrow_timestamp_tz_helper(sf_bool use_zero_precision) {
    ...
    const char * f2_neg_reg_date  = "-1970-01-01 12:34:56.987654321";
    const char * f2_neg_reg_time  = "1970-01-01 -12:34:56.987654321";
    ...
    TEST_CASE_TO_STRING p0_test_cases[] = {
        ...
        { .c1 =  8, .c2 = f1_trash,         .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 =  9, .c2 = f1_neg_zero_time, .c2_len = 20, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 10, .c2 = f1_neg_reg_date,  .c2_len = 20, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 11, .c2 = f1_neg_reg_time,  .c2_len = 20, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 12, .c2 = f1_zero_day,      .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 13, .c2 = f1_zero_month,    .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 14, .c2 = f1_oob_ss,        .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 15, .c2 = f1_oob_mm,        .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 16, .c2 = f1_oob_hh,        .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 17, .c2 = f1_oob_day,       .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 18, .c2 = f1_oob_month,     .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 }
    };
    ...
    TEST_CASE_TO_STRING p9_test_cases[] = {
        ...
        { .c1 =  7, .c2 = f2_trash,         .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 =  8, .c2 = f2_neg_zero_time, .c2_len = 30, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 =  9, .c2 = f2_neg_reg_date,  .c2_len = 30, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 10, .c2 = f2_neg_reg_time,  .c2_len = 30, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 11, .c2 = f2_zero_day,      .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 12, .c2 = f2_zero_month,    .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 13, .c2 = f2_oob_nano,      .c2_len = 30, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 14, .c2 = f2_oob_ss,        .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 15, .c2 = f2_oob_mm,        .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 16, .c2 = f2_oob_hh,        .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 17, .c2 = f2_oob_day,       .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 18, .c2 = f2_oob_month,     .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 }
    };
