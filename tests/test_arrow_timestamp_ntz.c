...
void test_arrow_timestamp_ntz_helper(sf_bool use_zero_precision) {
    ...
    const char * f1_min           = "0000-01-01 00:00:00";
    ...
    const char * f2_min           = "0000-01-01 00:00:00.000000000";
    ...
    TEST_CASE_TO_STRING p0_test_cases[] = {
        ...
        { .c1 =  1, .c2 = f1_epoch_eve,     .c2_len = 19, .c2_out = f1_epoch_eve,   .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  2, .c2 = f1_epoch,         .c2_len = 19, .c2_out = f1_epoch,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  3, .c2 = f1_epochalypse,   .c2_len = 19, .c2_out = f1_epochalypse, .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  4, .c2 = f1_min,           .c2_len = 19, .c2_out = f1_min,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  5, .c2 = f1_max,           .c2_len = 19, .c2_out = f1_max,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  6, .c2 = f1_noon,          .c2_len = 19, .c2_out = f1_noon,        .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  7, .c2 = f3_min,           .c2_len = 26, .c2_out = f3_min,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  8, .c2 = f3_max,           .c2_len = 26, .c2_out = f3_max,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  9, .c2 = f3_reg_neg_hh,    .c2_len = 26, .c2_out = f3_reg_neg_hh,  .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 10, .c2 = f3_reg_neg_mm,    .c2_len = 26, .c2_out = f3_reg_neg_mm,  .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 11, .c2 = f3_reg_pos_hh,    .c2_len = 26, .c2_out = f3_reg_pos_hh,  .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 12, .c2 = f3_reg_pos_mm,    .c2_len = 26, .c2_out = f3_reg_pos_mm,  .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 13, .c2 = empty,            .c2_len = 0,  .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 14, .c2 = f1_trash,         .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 15, .c2 = f1_zero_day,      .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 16, .c2 = f1_zero_month,    .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 17, .c2 = f1_oob_ss,        .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 18, .c2 = f1_oob_mm,        .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 19, .c2 = f1_oob_hh,        .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 20, .c2 = f1_oob_day,       .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 21, .c2 = f1_oob_month,     .c2_len = 19, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 22, .c2 = f3_neg_trash,     .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 23, .c2 = f3_pos_trash,     .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 24, .c2 = f3_oob_neg_hh,    .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 25, .c2 = f3_oob_neg_mm,    .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 26, .c2 = f3_oob_pos_hh,    .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 27, .c2 = f3_oob_pos_mm,    .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 28, .c2 = f3_dne_neg_tz,    .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 29, .c2 = f3_dne_pos_tz,    .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 30, .c2 = f3_bad_neg_hh,    .c2_len = 25, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 31, .c2 = f3_bad_neg_mm,    .c2_len = 25, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 32, .c2 = f3_bad_pos_hh,    .c2_len = 25, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 33, .c2 = f3_bad_pos_mm,    .c2_len = 25, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 34, .c2 = f3_past_min,      .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 35, .c2 = f3_past_max,      .c2_len = 26, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
    };

    TEST_CASE_TO_STRING p9_test_cases[] = {
        { .c1 =  0, .c2 = NULL,             .c2_len = 0,  .c2_out = NULL,           .c2_is_null = SF_BOOLEAN_TRUE },
        { .c1 =  1, .c2 = f2_epoch_eve,     .c2_len = 29, .c2_out = f2_epoch_eve,   .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  2, .c2 = f2_epoch,         .c2_len = 29, .c2_out = f2_epoch,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  3, .c2 = f2_epochalypse,   .c2_len = 29, .c2_out = f2_epochalypse, .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  4, .c2 = f2_min,           .c2_len = 29, .c2_out = f2_min,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  5, .c2 = f2_max,           .c2_len = 29, .c2_out = f2_max,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  6, .c2 = f2_noon,          .c2_len = 29, .c2_out = f2_noon,        .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  7, .c2 = f4_min,           .c2_len = 36, .c2_out = f4_min,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  8, .c2 = f4_max,           .c2_len = 36, .c2_out = f4_max,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 =  9, .c2 = f4_reg_neg_hh,    .c2_len = 36, .c2_out = f4_reg_neg_hh,  .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 10, .c2 = f4_reg_neg_mm,    .c2_len = 36, .c2_out = f4_reg_neg_mm,  .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 11, .c2 = f4_reg_neg_hh,    .c2_len = 36, .c2_out = f4_reg_pos_hh,  .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 12, .c2 = f4_reg_neg_mm,    .c2_len = 36, .c2_out = f4_reg_pos_mm,  .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 13, .c2 = f2_trash,         .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 14, .c2 = f2_zero_month,    .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 15, .c2 = f2_zero_day,      .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 16, .c2 = f2_oob_nano,      .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 17, .c2 = f2_oob_ss,        .c2_len = 30, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 18, .c2 = f2_oob_mm,        .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 19, .c2 = f2_oob_hh,        .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 20, .c2 = f2_oob_day,       .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 21, .c2 = f2_oob_month,     .c2_len = 29, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 22, .c2 = f4_neg_trash,     .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 23, .c2 = f4_pos_trash,     .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 24, .c2 = f4_oob_neg_hh,    .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 25, .c2 = f4_oob_neg_mm,    .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 26, .c2 = f4_oob_pos_hh,    .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 27, .c2 = f4_oob_pos_mm,    .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 28, .c2 = f4_dne_neg_tz,    .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 29, .c2 = f4_dne_pos_tz,    .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 30, .c2 = f4_bad_neg_hh,    .c2_len = 35, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 31, .c2 = f4_bad_neg_mm,    .c2_len = 35, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 32, .c2 = f4_bad_pos_hh,    .c2_len = 35, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 33, .c2 = f4_bad_pos_mm,    .c2_len = 35, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 34, .c2 = f4_past_min,      .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 },
        { .c1 = 35, .c2 = f4_past_max,      .c2_len = 36, .c2_out = "",             .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100035 }
    };
