...
void test_timestamp_tz_helper(sf_bool use_arrow, sf_bool useZeroPrecision)
{
    TEST_CASE_TO_STRING test_cases[] = {
        {.c1in = 1, .c2in = "2014-05-03 13:56:46.123 +09:00", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "2014-05-03 13:56:46 +09:00" : "2014-05-03 13:56:46.12300 +09:00"},
        {.c1in = 2, .c2in = "1969-11-21 05:17:23.0123 -01:00", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "1969-11-21 05:17:23 -01:00" : "1969-11-21 05:17:23.01230 -01:00"},
        {.c1in = 3, .c2in = "1960-01-01 00:00:00.0000", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "1960-01-01 00:00:00 -05:00" : "1960-01-01 00:00:00.00000 -05:00"},
        // timestamp before 1600 doesn't work properly.
        {.c1in = 4, .c2in = "1500-01-01 00:00:00.0000", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "1500-01-01 00:00:02 -04:56" : "1500-01-01 00:00:02.00000 -04:56"},
#ifndef __linux__
        {.c1in = 5, .c2in = "0001-01-01 00:00:00.0000", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "0001-01-01 00:00:02 -04:56" : "0001-01-01 00:00:02.00000 -04:56"},
#else
        {.c1in = 5, .c2in = "0001-01-01 00:00:00.0000", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "1-01-01 00:00:02 -04:56" : "1-01-01 00:00:02.00000 -04:56"},
#endif // __linux__
        {.c1in = 6, .c2in = "9999-01-01 00:00:00.0000", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "9999-01-01 00:00:00 -05:00" : "9999-01-01 00:00:00.00000 -05:00"},
        {.c1in = 7, .c2in = "99999-12-31 23:59:59.9999", .c2out = "", .error_code = 100035},
        {.c1in = 8, .c2in = NULL, .c2out = NULL},
        {.c1in = 9, .c2in = "2030-07-16 09:01:12.0987 +04:30", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "2030-07-16 09:01:12 +04:30" : "2030-07-16 09:01:12.09870 +04:30"},
        {.c1in = 10, .c2in = "1804-10-23 13:08:48.8765 +04:30", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "1804-10-23 13:08:48 +04:30" : "1804-10-23 13:08:48.87650 +04:30"},
        {.c1in = 11, .c2in = "1969-11-21 08:19:34.123 -02:30", .c2out = useZeroPrecision == SF_BOOLEAN_TRUE ? "1969-11-21 08:19:34 -02:30" : "1969-11-21 08:19:34.12300 -02:30"},
