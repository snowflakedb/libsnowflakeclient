...
void test_decfloat_helper(sf_bool use_arrow) {
    ...
    DECFLOAT_TESTING_CASE test_cases[] = {
      ...
      {.id = 3, .c1in = "99999999999999999999999999999999999999", .c1strout = "99999999999999999999999999999999999999", .c2in = "999999999999999999999999999999999999999", .c2strout = "1e39"},
