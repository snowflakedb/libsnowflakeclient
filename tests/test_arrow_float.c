...
void test_arrow_float(void** unused) {
    ...
    TEST_CASE_TO_STRING test_cases[] = {
        ...
        { .c1 = 14, .c2 = &s0_oob_pos,   .c2_len = 19, .c2_out = &s0_oob_pos_out,   .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 15, .c2 = &s8_oob_neg,   .c2_len = 17, .c2_out = &s8_oob_neg,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 16, .c2 = &s8_max_neg,   .c2_len = 17, .c2_out = &s8_max_neg,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 17, .c2 = &s8_reg_neg,   .c2_len = 11, .c2_out = &s8_reg_neg,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 18, .c2 = &s8_zero,      .c2_len = 1,  .c2_out = &s8_zero_out,      .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 19, .c2 = &s8_one,       .c2_len = 1,  .c2_out = &s8_one_out,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 20, .c2 = &s8_reg_pos,   .c2_len = 10, .c2_out = &s8_reg_pos,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 21, .c2 = &s8_max_pos,   .c2_len = 16, .c2_out = &s8_max_pos,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 22, .c2 = &s8_oob_pos,   .c2_len = 16, .c2_out = &s8_oob_pos,       .c2_is_null = SF_BOOLEAN_FALSE }
    };
