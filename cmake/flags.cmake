...
if (LINUX)
    ...
    if (CLIENT_CODE_COVERAGE)    # Only when code coverage is enabled
        ...
        add_compile_options(--coverage -fprofile-arcs -ftest-coverage -O0 $<$<COMPILE_LANGUAGE:CXX>:-fno-elide-constructors> -fno-inline -fno-inline-small-functions -fno-default-inline -DTEST_DEBUG)
